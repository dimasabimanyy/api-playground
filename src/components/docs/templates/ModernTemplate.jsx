...
const ModernTemplate = ({ docData }) => {
  ...
  const generateCurlExample = (request) => {
    let curl = `curl -X ${request.method} "${
      docData.customization?.baseUrl || "https://api.example.com"
    }${request.url}"`;
  ...
  return (
    <div className={`min-h-screen ${themeClasses.bg.primary}`}>
      ...
      <div
        ...
        } border-b ${themeClasses.border.primary}`}
      >
        <div className="max-w-6xl mx-auto px-6 py-16">
          <div className="text-center mb-12">
            ...
            <h1
              className={`text-4xl md:text-5xl font-bold mb-4 ${themeClasses.text.primary}`}
            >
              {docData.customization?.title || "API Documentation"}
            </h1>

            <p
              className={`text-xl ${themeClasses.text.secondary} max-w-2xl mx-auto mb-8`}
            >
              {docData.customization?.description || ""}
            </p>

            {docData.customization?.baseUrl && (
              <div
                className={`inline-flex items-center gap-3 px-4 py-3 rounded-lg ${themeClasses.card.base} ${themeClasses.border.primary} border`}
              >
                <span
                ...
                <code
                  className={`text-sm font-mono ${themeClasses.text.accent} bg-blue-50 dark:bg-blue-900/30 px-2 py-1 rounded`}
                >
                  {docData.customization.baseUrl}
                </code>
                <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                value:
                  new Set(
                    docData.collections?.flatMap(
                      (col) => col.requests?.map((req) => req.method) || []
                    )
                  ).size || 0,
                icon: Code,
                color: "purple",
              ...
              return (
                <div
                  key={idx}
                  className={`p-6 rounded-xl ${themeClasses.card.base} border ${themeClasses.border.primary} text-center`}
                >
                  <div
                  ...
                  <div
                    className={`text-2xl font-bold ${themeClasses.text.primary} mb-1`}
                  >
                    {stat.value}
                  </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          <div key={collection.id} className="mb-16">
            ...
            <div className="mb-8">
              ...
              <p className={`text-lg ${themeClasses.text.secondary}`}>
                ...
                {(collection.requests?.length || 0) !== 1 ? "s" : ""}
              </p>
            </div>
              ...
              {collection.requests?.map((request) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <div
                            className={`px-3 py-1.5 rounded-md text-sm font-semibold ${methodColors.bg} ${methodColors.text}`}
                          >
                            {request.method}
                          </div>
                          <div>
                            ...
                            <code
                              className={`text-sm ${themeClasses.text.secondary} font-mono`}
                            >
                              {request.url}
                            </code>
                          </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {isExpanded ? (
                            <ChevronDown
                              className={`w-5 h-5 ${themeClasses.text.tertiary}`}
                            />
                          ) : (
                            <ChevronRight
                              className={`w-5 h-5 ${themeClasses.text.tertiary}`}
                    ...
                    {isExpanded && (
                      <div
                        className={`border-t ${themeClasses.border.primary}`}
                      >
                        {/* Tabs */}
                        <div
                          className={`border-b ${themeClasses.border.primary} ${themeClasses.bg.secondary}`}
                        >
                          <div className="flex">
                            {[
                              "overview",
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-6">
                              <div>
                                ...
                                <p className={`${themeClasses.text.secondary}`}>
                                  {request.description ||
                                    `${request.method} request to ${request.url}`}
                                </p>
                              </div>
                              ...
                              <div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  <div
                                    className={`p-4 rounded-lg ${themeClasses.bg.secondary}`}
                                  >
                                    <div
                                      className={`text-sm font-medium ${themeClasses.text.secondary} mb-1`}
                                    >
                                      Method
                                    </div>
                                    <div
                                  ...
                                  >
                                    ...
                                    <code
                                      className={`text-lg font-mono ${themeClasses.text.primary}`}
                                    >
                                      {request.url}
                                    </code>
                                  </div>
                          ...
                          {currentTab === "parameters" && (
                            <div>
                              ...
                              >
                                <FileText
                                  className={`h-8 w-8 mx-auto mb-2 ${themeClasses.text.tertiary}`}
                                />
                                <p
                                ...
                                <div className="space-y-3">
                                  {Object.entries(request.headers).map(
                                    ([key, value]) => (
                                      <div
                                        key={key}
                                        className={`p-4 rounded-lg ${themeClasses.bg.secondary} border ${themeClasses.border.primary}`}
                                      >
                                        <div className="flex items-center justify-between">
                                          <div>
                                            <code
                                            ...
                                            <div
                                              className={`text-sm ${themeClasses.text.secondary} mt-1`}
                                            >
                                              {value}
                                            </div>
                                          </div>
                          ...
                          {currentTab === "examples" && (
                            <div>
                              ...
                              {/* cURL Example */}
                              <div
                                className={`rounded-lg ${themeClasses.bg.secondary} border ${themeClasses.border.primary} overflow-hidden`}
                              >
                                <div
                                  className={`px-4 py-3 border-b ${themeClasses.border.primary} flex items-center justify-between`}
                                >
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span
                                      className={`text-sm font-medium ${themeClasses.text.secondary} ml-2`}
                                    >
                                      cURL
                                    </span>
                                  </div>
                                ...
                                <div className="p-4">
                                  <pre
                                    className={`text-sm font-mono ${themeClasses.text.primary} overflow-x-auto`}
                                  >
                                    {generateCurlExample(request)}
                                  </pre>
                                </div>
        ...
        {/* Footer */}
        <div
          className={`text-center py-12 border-t ${themeClasses.border.primary}`}
        >
