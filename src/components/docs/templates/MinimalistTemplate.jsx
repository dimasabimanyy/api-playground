...
const Sidebar = ({
  ...
  return (
    <>
      ...
      <div
        className={`lg:sticky lg:top-16 lg:h-[calc(100vh-4rem)] w-full lg:w-80 bg-white border-r border-gray-200 z-50 transform transition-transform duration-300 overflow-y-auto scrollbar-hide hover:scrollbar-show ${
          isOpen
          ...
          <button
            onClick={() => {
              navigator.clipboard.writeText(
                `${window.location.origin}${window.location.pathname}#${endpointId}`
              );
            }}
...
print(response.json())`;
  ...
  return (
    <div 
      className="sticky top-16 h-[calc(100vh-4rem)] w-full bg-white overflow-y-auto scrollbar-hide border-l border-gray-200 hover:scrollbar-show"
      style={{
        scrollbarWidth: 'none',
        msOverflowStyle: 'none',
      }}
  ...
  "error": {
    ...
    "request_id": "req_123456789"
                ...
                <section id="pagination" className="mb-16">
                  ...
                  <p className="text-base text-gray-700 leading-relaxed mb-4">
                    List endpoints support pagination using cursor-based
                ...
                <section id="webhooks" className="mb-16">
                  ...
                  <p className="text-base text-gray-700 leading-relaxed mb-4">
                    ...
                    events occur in your account. Configure webhook endpoints to
                    receive HTTP POST requests whenever specific events happen.
                  </p>
                  ...
                  <div id="webhook-security" className="mb-8">
                    ...
                    <p className="text-base text-gray-700 leading-relaxed mb-4">
                      All webhook requests include a signature header that you
                      can use to verify the request came from our servers.
                    </p>
                    <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                      ...
                      <p className="text-purple-800 text-sm">
                        Compare the <code>X-Webhook-Signature</code> header with
                        your computed HMAC-SHA256 signature.
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <section id="testing" className="mb-16">
                  ...
                  <p className="text-base text-gray-700 leading-relaxed mb-4">
                    We provide a comprehensive testing environment where you can
                    experiment with our API without affecting production data.
                  </p>
                  <div className="bg-green-50 border border-green-200 rounded-lg p-6">
                    <h4 className="font-semibold text-green-900 mb-3">
                      Test Environment
                    ...
                    <p className="text-green-800 mb-2">
                      Use the test base URL for all your development and
                      testing:
                    </p>
                    <code className="bg-green-100 px-3 py-2 rounded text-green-900">
                      https://api-test.example.com/v1
                    </code>
                  </div>
                </section>
...
export const MinimalistConfig = {
  name: "Minimalist",
  description:
    "Clean, focused design with fixed sidebars and comprehensive parameter documentation",
